...
namespace RhinoTicketingSystem.Components.Pages
{
    public partial class Project
    {
        ...
        protected async Task Search(ChangeEventArgs args)
        {
            ...
            tblProjects = await db_a79800_ticketService.GetTblProjects(new Query { Filter = $@"i => i.Name.Contains(@0) || i.CreatedBy.Contains(@0)", FilterParameters = new object[] { search } });
        }
        ...
        {
            await DialogService.OpenAsync<AddProject>("Add TblProject", null);
            await grid0.Reload();
        }

        protected async Task EditRow(RhinoTicketingSystem.Models.db_a79800_ticket.TblProject args)
        {
            await DialogService.OpenAsync<EditProject>("Edit TblProject", new Dictionary<string, object> { {"Id", args.Id} });
        }
