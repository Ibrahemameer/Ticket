...
namespace RhinoTicketingSystem.Components.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<RhinoTicketingSystem.Models.ApplicationUser> users;
        protected RadzenDataGrid<RhinoTicketingSystem.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(RhinoTicketingSystem.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(RhinoTicketingSystem.Models.ApplicationUser user)
        {
            try
            {
