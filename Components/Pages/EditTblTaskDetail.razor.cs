...
{
    public partial class EditTblTaskDetail
    {
        [Inject]
        ...
        {
            tblTaskDetail = await db_a79800_ticketService.GetTblTaskDetailById(Id);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await db_a79800_ticketService.UpdateTblTaskDetail(Id, tblTaskDetail);
