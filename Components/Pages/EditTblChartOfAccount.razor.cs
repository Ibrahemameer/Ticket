...
{
    public partial class EditTblChartOfAccount
    {
        [Inject]
        ...
        {
            tblChartOfAccount = await db_a79800_ticketService.GetTblChartOfAccountByChartId(ChartId);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await db_a79800_ticketService.UpdateTblChartOfAccount(ChartId, tblChartOfAccount);
