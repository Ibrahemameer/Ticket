...
{
    public partial class AddTblEngineer
    {
        [Inject]
        ...
        {
            tblEngineer = new RhinoTicketingSystem.Models.db_a79800_ticket.TblEngineer();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await db_a79800_ticketService.CreateTblEngineer(tblEngineer);
