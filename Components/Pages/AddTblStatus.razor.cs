...
{
    public partial class AddTblStatus
    {
        [Inject]
        ...
        {
            tblStatus = new RhinoTicketingSystem.Models.db_a79800_ticket.TblStatus();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await db_a79800_ticketService.CreateTblStatus(tblStatus);
