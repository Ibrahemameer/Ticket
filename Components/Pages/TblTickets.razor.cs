...
namespace RhinoTicketingSystem.Components.Pages
{
    public partial class TblTickets
    {
        ...
        {
            await DialogService.OpenAsync<AddTblTicket>("Add TblTicket", null);
            await grid0.Reload();
        }

        protected async Task EditRow(RhinoTicketingSystem.Models.db_a79800_ticket.TblTicket args)
        {
            await DialogService.OpenAsync<EditTblTicket>("Edit TblTicket", new Dictionary<string, object> { {"TicketId", args.TicketId} });
        }
