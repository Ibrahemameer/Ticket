...
{
    public partial class EditTblDepartment
    {
        [Inject]
        ...
        {
            tblDepartment = await db_a79800_ticketService.GetTblDepartmentById(Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await db_a79800_ticketService.UpdateTblDepartment(Id, tblDepartment);
