...
namespace RhinoTicketingSystem.Components.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<RhinoTicketingSystem.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(RhinoTicketingSystem.Models.ApplicationRole role)
        {
            try
            {
