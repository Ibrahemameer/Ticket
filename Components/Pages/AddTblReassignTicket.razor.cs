...
{
    public partial class AddTblReassignTicket
    {
        [Inject]
        ...
        {
            tblReassignTicket = new RhinoTicketingSystem.Models.db_a79800_ticket.TblReassignTicket();
            ...
            tblStatusesForStatusId = await db_a79800_ticketService.GetTblStatuses();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await db_a79800_ticketService.CreateTblReassignTicket(tblReassignTicket);
